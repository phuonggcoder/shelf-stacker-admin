...
app.get('/event-notifications', (req, res) => res.sendFile(path.join(__dirname, 'views', 'event-notifications.html')));
...
app.get('/test-notification', (req, res) => res.sendFile(path.join(__dirname, 'test-notification.html')));
